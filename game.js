...
g.fillStyle='#11141d';g.fillRect(gx-(gun?46:16),gy2-(gun?70:96),(gun?92:32),(gun?70:96));
g.fillStyle=gun?'#6b4d26':'#33547e';g.fillRect(gx-(gun?38:10),gy2-(gun?64:90),(gun?76:20),(gun?50:70));
g.fillStyle=gun?'#ffd23b':'#5cffb1';g.fillRect(gx-(gun?38:10),gy2-(gun?64:90),(gun?76:4),4);
...
// size badge — measured payload 28936 B ≈ 28.3KB of 96KB budget
const SIZE_TXT='28.3KB / 96KB';
